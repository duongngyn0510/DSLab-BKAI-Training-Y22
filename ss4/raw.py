...
def gen_data_and_vocab():
    ...
    path = 'E:/Data Science/TrainML/ss1/data/20news-bydate'
    ...
    vocab.sort()
    with open('./datasets/vocab_raw.txt', 'w') as f:
        f.write('\n'.join(vocab))
    ...
    with open('./datasets/20news_train_raw.txt', 'w') as f:
        f.write('\n'.join(train_data))

    with open('./datasets/20news_test_raw.txt', 'w') as f:
        f.write('\n'.join(test_data))
